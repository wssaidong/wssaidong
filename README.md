...
```
  ┌─────────────┐     ┌──────────────┐     ┌─────────────┐     ┌──────────────┐
  │  新浪财经   │ ──► │  AAna Scanner │ ──► │  技术评分   │ ──► │  报告生成   │
  │  实时数据   │     │  09:35 自动   │     │  v2.4 算法  │     │  Markdown    │
  └─────────────┘     └──────────────┘     └─────────────┘     └──────┬───────┘
                                                                      │
  ┌─────────────┐     ┌──────────────┐     ┌─────────────┐           │
  │  x-compass  │ ◄── │  GitHub Raw  │ ◄── │  Push Repo  │ ◄──────────┘
  │  热度图看板  │     │  每日同步    │     │  17:00 自动  │
  └──────┬──────┘     └──────────────┘     └─────────────┘
         │
         ▼
...
<details open>
<summary><img src="https://img.shields.io/badge/AAna-00FF41?style=flat-square&logo=Python&logoColor=00FF41&labelColor=0A0E1A"/> AAna — A股智能选股系统 v2.4</summary>
...
┌──────────────────────────────────────────────────────────────────────┐
│                                                                       │
│  wssaidong@mainframe ~ % cat contact.txt                              │
│                                                                       │
